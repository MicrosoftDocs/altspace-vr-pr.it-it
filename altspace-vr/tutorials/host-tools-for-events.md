...
> [!NOTE]
> Se è necessario ricongiungersi all'evento, passare al Campofire e tornare indietro, perdere la connessione Internet, passare dalla stanza alla stanza, quando si torna non si sarà in diretta. Assicurarsi di fare di nuovo clic su Go On-Air una volta tornati.
...
Per tenere traccia, il pannello di partecipazione accenderà anche una notifica rossa quando si hanno ospiti in attesa di essere chiamati e sarà possibile sapere per quanto tempo ognuno dei guest è stato in attesa.
